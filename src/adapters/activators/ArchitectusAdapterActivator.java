 ...
 *
 */
public class ArchitectusAdapterActivator extends GenericAdapterActivator implements ArchitectusActivator {

	ArchitectusParams params;
	Vector<Card> handCopy; // copy of the hand for mapping purposes
	
	public ArchitectusAdapterActivator(int fieldPosition, Game game, Card theCard) {
