 ...
 * 
 */
public class TelephoneBoxAdapterActivator extends GenericAdapterActivator
		implements TelephoneBoxActivator {

	TelephoneBoxParams params;

	public TelephoneBoxAdapterActivator(int fieldPosition, Game game,
			Card theCard) {
